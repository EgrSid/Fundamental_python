...
bg = pygame.image.load('C:\projects\Python\Fundamental_python\IMPORTANT_PROGRAMMES\img/bg.png')  # загружаю картинку заднего фона игры
ground_img = pygame.image.load('C:\projects\Python\Fundamental_python\IMPORTANT_PROGRAMMES\img/ground.png')  # загружаю землю
...
score = 0
pass_pipe = False
button_img = pygame.image.load('C:\projects\Python\Fundamental_python\IMPORTANT_PROGRAMMES\img/restart.png')
...
class Bird(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        for num in range(1, 3 + 1):
            img = pygame.image.load(f'C:\projects\Python\Fundamental_python\IMPORTANT_PROGRAMMES\img/bird{num}.png')
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load('C:\projects\Python\Fundamental_python\IMPORTANT_PROGRAMMES\img/pipe.png')
        self.rect = self.image.get_rect()
        if position == 1:
